...
import model.*;
import server.cpuScheduling.Fcfs;
import server.cpuScheduling.Priority;
import server.cpuScheduling.Rr;
import server.cpuScheduling.Sjf;
/**
 *
 * @author TrungNguyen
 */
public class ServerControl {
    ...
    Sjf ojSjf = new Sjf();
    Priority ojPriority = new Priority();
    Fcfs ojFCFS = new Fcfs();
    Rr ojRR = new Rr();
//    int ktKey = 0;
