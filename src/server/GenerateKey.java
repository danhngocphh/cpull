...
public class GenerateKey {
    ...
    public static void main(String[] args) {
        ...
        // Demo chỉ sử dụng 1024 bit. Nhưng theo khuyến cáo thì độ dài khóa nên tối thiểu là 2048
                    ...
                    File publicKeyFile = createKeyFile(new File("D:\\Download\\thang11-2020\\QLST_UDP\\QLST_UDP\\laplich1\\keyRSA\\publicKey.rsa"));
                    File privateKeyFile = createKeyFile(new File("D:\\Download\\thang11-2020\\QLST_UDP\\QLST_UDP\\laplich1\\keyRSA\\privateKey.rsa"));
